...
class LaterNewsVC: UIViewController {
    private let viewModel: LaterNewsViewModel
    ...
    init(viewModel: LaterNewsViewModel){
    ...
    private func setupViews(){
        ...
        navigationItem.setTitleSubtitle(sub: "Прочитать позже")
    }
...
extension LaterNewsVC: SideMenuDelegate {
